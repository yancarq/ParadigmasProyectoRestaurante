<?php
	...
	class funcionesSector {
		...
		public function mostrarSectorTodo(){
					$conexion = new Conexion();
					$query = $conexion->crearConexion()->query("SELECT * FROM tbsector");
		...
		public function insertarSector($sector){
	        ...
	        $sectorEstado= $sector->getSectorEstado();
	       	...
	       	$consulta ="INSERT INTO tbsector (sectornombre, sectorcapacidadpersonas, sectorcapacidadmesas, sectorestado) VALUES ('$sectorNombre', '$sectorCapacidadPersonas', '$sectorCapacidadMesas', '$sectorEstado')";
